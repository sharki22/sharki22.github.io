	...
	<section class="hero">
		...
		<div class="hero-content">
			...
			<p class="hero-subtitle animate-fade-up" style="animation-delay: 200ms">
				CS Student &middot; C++ Dev &middot; Open-Source Hobbyist
			</p>
			<p class="hero-desc animate-fade-up" style="animation-delay: 300ms">
				Building things for the fun of it. Coffee-fueled code, occasional brilliance,
				and a healthy dose of procrastination.
			</p>
			...
			<div class="hero-socials animate-fade-up" style="animation-delay: 500ms">
				<a href="https://github.com/sharki22" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
	...
	<section class="contact-section" id="contact">
		<div class="contact-card glass">
			...
			<div class="contact-links">
				<a href="https://github.com/sharki22" target="_blank" rel="noopener noreferrer" class="contact-link">
